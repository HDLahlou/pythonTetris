...
def doneStroke(event):
	...
	canvas.addtag('line', 'withtag', 'currentline')
...
id = canvas.create_rectangle((10,85,30,105), fill="white", tags=('palette','erase'))
mylabel= canvas.create_text(20,95, text="C", tags=('label'))
canvas.tag_bind(id, "<Button-1>", lambda x: clearCanvas())
